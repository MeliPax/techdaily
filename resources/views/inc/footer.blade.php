...
<div class="container pt-5 border-bottom" style="color: white ">
    <div class="row">
        {{-- A skecthed logo --}}
      ...
      {{-- End of the skecthed logo --}}
      <div class="col-md-3 col-sm-12 mb-3">
        <h5 class="mb-4 font-weight-bold text-uppercase">E-learning platform</h5>
        <p>Making learning easy for everyone! <br> Re-defining education to educate the world.</p>
      </div>
